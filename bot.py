...
Three-layer signal: distribution bias (A) + sequence prediction (B) + pattern heuristics (C).
"""
...
class R10EOBot:
    ...
    async def run(self):
        ...
        log.info(f"Layer 3 (C): StreakReversal + ParityImbalance + HotDigits ({S.LAYER3_REQUIRED}/3)")
    ...
    async def _evaluate(self):
        ...
        log.info(
            ...
            f"L1={signal.layer1_score}/3 L2={signal.layer2_score}/3 L3={signal.layer3_score}/3 | "
            f"stake=${stake:.2f} | "
    ...
    async def _settle(self, contract, meta):
        ...
        self.tlog.record(
            ...
            layer3_score = signal.layer3_score,
